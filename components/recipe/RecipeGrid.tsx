    ...
    <>
      ...
      <div className="relative flex items-center mb-8 max-w-md mx-auto">
        <Input
          ...
          className="pl-10 pr-4 py-2 w-full border rounded-full border-gray-300 dark:border-gray-600 focus:border-pink-500 dark:focus:border-pink-400 focus:ring-pink-500/20 dark:focus:ring-pink-400/20 dark:bg-gray-800 dark:text-white"
          value={searchQuery}
