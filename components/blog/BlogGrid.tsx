      ...
      <div className="flex justify-center mb-10">
        <form onSubmit={handleSearchSubmit} className="relative w-full max-w-lg">
          <Input
            ...
            className="w-full rounded-full border-gray-300 dark:border-gray-600 pr-12 py-2 dark:bg-gray-800 dark:text-white focus:border-pink-500 dark:focus:border-pink-400 focus:outline-none"
          />
          <Button
            type="submit"
            size="icon"
